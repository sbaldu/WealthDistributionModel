...
That is close to the real one, i.e. $\frac{9}{10}$: this error is due to the fact that we are calculating the surface area of the whole symplex, whereas the microstates are discrete. \\
Nonetheless, in the limit where the number or agents gets very large, the number of microstates also gets large and they get very dense. In this limit the error vanishes, thus making it correct to use the surface area of the symplex in the calculation.
