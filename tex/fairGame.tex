...
\end{figure}
For example, the point (3, 0, 0) is part of the surface and represents the state in which the i-agent has 3 coins and the others 0. \\
Likewise, the point (2, 1, 0), also on the surface, represent the state in which the i-agent has 2 coins, the j-agent has 1 and the k-agent has 0, and so on.
