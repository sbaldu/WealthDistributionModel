...
This assumption is actually strong but will be justified by comparison with simulated data. 
...
In particular, it gives the parameters $C = 0.27$ and $\gamma = -0.21 \pm 0.01$, compatible with the expected value $\alpha^{-1} = 0.20$.
