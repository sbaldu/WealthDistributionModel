...
\end{figure}
We want to normalize it all as we are looking for a pdf, so we can divide $V_n\left(y, N\right)$ by $V_n\left(N, N\right)$ and neglect the overestimation, finding the cumulative distribution
\begin{equation*}
