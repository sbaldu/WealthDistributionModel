...
\end{figure}
\\
We can compare this plot with the distribution of real data. For example, here is the distribution of income in the USA from the 1994 census in log-log scale (this dataset will be discussed more in detail in the next section):
\begin{figure}[ht!]
    \centering
