...
\begin{figure}[H]
    ...
    \caption{\emph{Wealth distribution for the saving model with the parameters $\varepsilon$ and $\bar{\varepsilon}$ taken as described in Eq. (\ref{eq:prefAttach}). By fitting the data we obtain an estimate for the exponent of $\la = -4.2$.}}
