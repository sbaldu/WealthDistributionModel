...
PYBIND11_MODULE(network, m) {
  ...
  pybind11::class_<SparseMatrix<bool>>(m, "SparseMatrix")
      ...
      .def("insert", static_cast<void (SparseMatrix<bool>::*)(int, int, bool)>(&SparseMatrix<bool>::insert))
      .def("insert", static_cast<void (SparseMatrix<bool>::*)(int, bool)>(&SparseMatrix<bool>::insert))
      .def("insert_or_assign",
           static_cast<void (SparseMatrix<bool>::*)(int, int, bool)>(&SparseMatrix<bool>::insert_or_assign))
      .def("insert_or_assign",
           static_cast<void (SparseMatrix<bool>::*)(int, bool)>(&SparseMatrix<bool>::insert_or_assign))
      .def("erase", &SparseMatrix<bool>::erase)
      .def("clear", &SparseMatrix<bool>::clear)
      .def("contains", static_cast<bool (SparseMatrix<bool>::*)(int, int) const>(&SparseMatrix<bool>::contains))
      .def("contains", static_cast<bool (SparseMatrix<bool>::*)(int) const>(&SparseMatrix<bool>::contains))
